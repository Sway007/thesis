...
\hitsetup{
  ...
  ctitlecover={对抗生成网络和神经风格转换技术对路况图像合成的实证研究},%放在封面中使用，自由断行
  ctitle={对抗生成网络和神经风格转换技术对路况图像合成的实证研究},%放在原创性声明中使用
  ...
  % 英文信息
  %=========
  etitle={An empirical study of GANs and Neural Style Transfers for road view image synthesis},
