...
\include{body/chapter_intro}
% \include{body/chapter2}
\include{body/chapter_deeproad}
\include{body/chapter_gan}
\include{body/chapter_nst}
% \include{body/chapter_finding}
\include{body/chapter_finding_n}
